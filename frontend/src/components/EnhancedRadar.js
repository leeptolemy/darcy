...
export function EnhancedRadar({ colors, status, data, targets, predictions, showPredictions, radarZoom, setRadarZoom, showMapBackground, setShowMapBackground, onTargetClick, onPredictionClick }) {
