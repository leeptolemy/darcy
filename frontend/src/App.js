...
function Dashboard({ status, loading, getStatusColor, startGateway, stopGateway, manualPublish, data, targets, events, logs, hasGateway, setSelectedTarget, setSelectedPrediction, predictions, showPredictions, radarZoom, setRadarZoom, showMapBackground, setShowMapBackground, colors }) {
  return (
    <div style={{ padding: 8 }}>
      {!hasGateway && (
        <div style={{ 
...
function DenseGrid({ status, loading, getStatusColor, startGateway, stopGateway, manualPublish, data, targets, events, logs, hasGateway, setSelectedTarget, setSelectedPrediction, predictions, showPredictions, radarZoom, setRadarZoom, showMapBackground, setShowMapBackground, colors }) {
